...
from mad.core.workspace import local_path_for_mount, workspace_path
...
# ---------------------------------------------------------------------------
# LocalWorkspaceProvisioner — concrete adapter implementing WorkspaceProvisioner
# ---------------------------------------------------------------------------
...
class LocalWorkspaceProvisioner:
    ...
    Delegates workspace creation/destruction to ``mad.core.workspace`` helpers
    and git operations to the free functions in this module.
    """
