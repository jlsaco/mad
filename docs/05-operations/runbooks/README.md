...
|---|---|---|
| Sandbox hardening | Wrap agent/tool execution in a bubblewrap (`bwrap`) sandbox so a runaway agent cannot touch the operator's real filesystem, home, or network. | Written — [`../../sandbox-bwrap.md`](../../sandbox-bwrap.md) |
